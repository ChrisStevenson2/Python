...
# add the two names together as one string
combined_names = name1 + name2
# convert all letters to lowercase
lower_names = combined_names.lower()
# logic steps - count the number of letters that match the word 'true love'
t = lower_names.count("t")
r = lower_names.count("r")
u = lower_names.count("u")
e = lower_names.count("e")
# place the count of the matches in this string
first_digit = t + r + u + e
...
# validate score and print results
