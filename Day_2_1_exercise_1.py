...
#Alternate line Declare integer conversion - first_digit = int(two_digit_number[0])
second_digit = two_digit_number[1]
#Alternate line Declare integer conversion - second_digit = int(two_digit_number[1]) - then the following wouldn't need the int declared on the lines below e.g. result1 = first_digit + second_digit
