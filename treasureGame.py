...
choice1 = input('As you walk down the dusty path you see a clearing ahead. You\'ve reached a cross road. Where do you want to go? Type "left" , "right" , or walk "straight" ahead. \n').lower()
if choice1 == "left":
  choice2 = input('You\'ve come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across. \n').lower()
  if choice2 == "wait":
    choice3 = input("A fisherman shows up with a boat and asks if you need a ride to the island.\n You arrive at the island unharmed. There is a house with 3 doors. One red, one yellow and one blue. Which color door do you choose? \n").lower()
    if choice3 == "red":
      print("It's a room full of fire. Game Over.")
    elif choice3 == "yellow":
      print("You found the treasure! You Win!")
    elif choice3 == "blue":
      print("You open the door and get blasted with icy cold water. Game Over.")
    else:
      print("Sorry, you picked a door that doesn't exist. Game Over.")
  elif choice2 == "right":
    print("You wade into the cold water and start shivering because the water is too cold to swim in besides, you do'nt want to ge attacked by an angry trout. Game Over.")
elif choice1 == "straight":
  print("You walk straight and eventually leave the forest, not finding any treasure. Game Over.")
else:
